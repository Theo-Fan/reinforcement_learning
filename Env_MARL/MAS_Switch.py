...
class GameEnv:
    ...
    def render_env(self):
        ...
        b = resize(a[:, :, 0], (10 * self.size_y, 10 * self.size_x), order=0, preserve_range=True, anti_aliasing=False)
        c = resize(a[:, :, 1], (10 * self.size_y, 10 * self.size_x), order=0, preserve_range=True, anti_aliasing=False)
        d = resize(a[:, :, 2], (10 * self.size_y, 10 * self.size_x), order=0, preserve_range=True, anti_aliasing=False)
